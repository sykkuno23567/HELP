...
//                        .setEmoji("💵")
   ...
   //                     .setEmoji("📌")
           ...
           //             .addComponent(btn3)
                    //    .addComponent(btn4)
                        .addComponent(btn5)
                    channel.send(`Welcome <@${button.clicker.user.id}> Wait.. <@&${adminRole}> `, {
                        embed: {
                          footer: 'Powered By Snap',
                            description: `Support will be with you shortly.
To close this ticket react with 🔒`,
                            color: ff0000
                        },
